const buttonsFirst = document.querySelectorAll(".button");
const popup = document.querySelector(".popup");
const overlay = document.querySelector(".overlay");

buttonsFirst.forEach((button) => {
...
function button1() {
  popup.innerHTML = `
        ...
        <h3 class="main--text">Good job!</h3>
        <p class="main--p">You clicked the button!</p>
        <button class="btn--ok">OK</button>
    `;
  popup.classList.remove("hide");
  overlay.classList.remove("hide");
  document.querySelector(".btn--ok").addEventListener("click", closePopup);
}
...
const notificationsTopRight = document.querySelector(
  ...
  notificationsTopLeft = document.querySelector(".notifications--topleft"),
